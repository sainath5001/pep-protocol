...
contract HelperComfig is Script {
    ...
    constructor() {
        if (block.chainid == 11155111) {
            ...
            activeNetworkConfig = getOrCreateAnvilEthCongig();
        } else {
    ...
    function getSepoliaEthConfig() public view returns (NetworkConfig memory) {
        return NetworkConfig({
            ...
            deployerKey: vm.envUint("SEPOLIA_DEPLOYER_PRIVATE_KEY")
        });
    }

    function getOrCreateAnvilEthCongig() public returns (NetworkConfig memory) {
